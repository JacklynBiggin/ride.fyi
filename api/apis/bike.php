<?php
function getBike($startPoint, $endPoint) {
  global $config;
  $ch = curl_init();
  ...
  return array('currency' => false, 'price' => 0, 'name' => 'Bike', 'distance' => $bikeDistance, 'time' => $bikeApiReturn['response']['route'][0]['summary']['baseTime']);
}
