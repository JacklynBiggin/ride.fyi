<?php
function getWalk($startPoint, $endPoint) {
  global $config;
  $ch = curl_init();
  ...
  return array('currency' => false, 'price' => 0, 'name' => 'Walking', 'distance' => $walkDistance, 'time' => $walkApiReturn['response']['route'][0]['summary']['baseTime']);
}
